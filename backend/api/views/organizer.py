...
class OrganizerAPI:
    ...
    @http_delete('/delete-event/{event_id}', response={204: dict, 403: ErrorResponseSchema, 404: ErrorResponseSchema}, auth=JWTAuth())
    ...
    @http_patch('/update-organizer', response={200: OrganizerResponseSchema, 401: ErrorResponseSchema, 404: ErrorResponseSchema}, auth=JWTAuth())
    ...
    @http_delete('/revoke-organizer', response={200: None, 403: ErrorResponseSchema, 404: ErrorResponseSchema}, auth=JWTAuth())
